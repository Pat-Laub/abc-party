...
![](typical_cond_int2.svg){.absolute bottom=0 left=150 width="350"}
...
[https://pat-laub.github.io/party-game](https://pat-laub.github.io/party-game)

</center>

{{< include _coin-flip-animations.qmd >}}

# Insurance & Theory {data-visibility="uncounted" background-image="unsw-yellow-shape.png"}
...
# In Practice {data-visibility="uncounted" background-image="unsw-yellow-shape.png"}
